...
export const DATA = {
  ...
  projects: [
    ...
    {
      title: "Horario Maker",
      href: "https://f4bian-pacheco.github.io/Horario-Maker/",
      dates: "Ener 2023",
      active: true,
      description:
        "Aplicacion web vainilla para la creacion de horarios de clases.",
      technologies: [
        "Javascript",
        "HTML",
        "CSS",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/F4bian-pacheco/Horario-Maker",
          icon: <Icons.github className="size-3" />,
        },
      ],
